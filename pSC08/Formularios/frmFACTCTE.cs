...
namespace pSC08
{
    public partial class frmFACTCTE : Form
    {
        string codCliente;
        int ed;
        double coluno;
        ...
        private void frmFACTCTE_Load(object sender, EventArgs e)
        {
            this.Text = "Movimiento Clientes";
            this.KeyPreview = true;
        }

        private void frmFACTCTE_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void EstiloDataGridView()
        {
            ...
            this.dgv.Columns.Add("Col02", "Documento");
